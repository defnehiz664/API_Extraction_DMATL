...
- DBTT_curve: plots of ductile-to-brittle transition temperature vs. any variable (grain size, dose, etc.)
- hardness: Vickers hardness maps, hardness vs. temperature, hardness vs. position plots
...
if __name__ == "__main__":
    DEFAULT_SCHEMA = str(PROJECT_ROOT / "schemas" / "w_dbtt" / "schema.yaml")
